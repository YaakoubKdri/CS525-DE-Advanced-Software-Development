...
public class Application {
	...
	public static void main(String[] args) {
        ...
        System.out.println("******************Lab4-a********************************");
        Iterator<Customer> iterator = customerCollection.ageIterator();
        while (iterator.hasNext()){
            Customer customer = iterator.next();
            System.out.println(customer);
        }
        System.out.println("********************Lab4-b1*******************************");
        Predicate<Customer> predicate1 = customer -> customer.getAddress().getCity().equals("Chicago");
        Iterator<Customer> filterIterator1 = customerCollection.filterIterator(predicate1);
        while (filterIterator1.hasNext()){
            System.out.println(filterIterator1.next());
        }
        System.out.println("********************Lab4-b2*******************************");
        Predicate<Customer> predicate2 = customer -> customer.getAddress().getZip().startsWith("12");
        Iterator<Customer> filterIterator2 = customerCollection.filterIterator(predicate2);
        while (filterIterator2.hasNext()){
            System.out.println(filterIterator2.next());
        }
        System.out.println("********************Lab4-c*******************************");
