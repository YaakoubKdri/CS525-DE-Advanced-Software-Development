...
public class JFrameCounter extends JFrame {
	...
	public JFrameCounter() {
		try {
            ...
            LoggingHandler loggingHandler = new LoggingHandler(databaseHandler);
            OddOrangeHandler oddOrangeHandler = new OddOrangeHandler(loggingHandler);
            OddBlueHandler oddBlueHandler = new OddBlueHandler(oddOrangeHandler);
            EvenGreenHandler evenGreenHandler = new EvenGreenHandler(oddBlueHandler);
            EvenRedHandler evenRedHandler = new EvenRedHandler(evenGreenHandler);

            counter.setHandler(evenRedHandler);
